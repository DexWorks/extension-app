...
import {TAB, EDITOR} from '../action-names';
import {get, copy, iterate, normalizeUrl, deepSet, hasValue, set as setMutable} from '../utils';
...
export default function(state={}, action) {
    ...
    if (hasValue(EDITOR, action.type)) {
        // update tab content one-by-one, if required
        let updated = new Map();
        let tabs = state.tabs;
        iterate(tabs, (tab, id) => {
